...
const EMPTY_DATA_OK_KEYS = new Set([
  'notamClosures', 'faaDelays', 'gpsjam',
  'outages',        // Cloudflare Radar may report 0 outages
  'wildfires',      // NASA FIRMS returns empty outside fire season
  'flightDelays',   // Aviationstack may have no delays
  'intlDelays',     // same
  'cableHealth',    // submarine cable source intermittent
  'riskScores',     // computed from other seeds, empty until full cycle
]);
