...
| **Tracking** | Live ADS-B aircraft positions with altitude, ground speed, heading, on-ground status | adsb.lol ([ODbL](https://opendatacommons.org/licenses/odbl/)) / airplanes.live & adsb.fi gap-fill / Wingbits / OpenSky |
