...
const RPC_CACHE_TIER: Record<string, CacheTier> = {
  ...
  '/api/economic/v1/get-eurostat-country-data': 'static',
  '/api/economic/v1/get-fao-food-price-index': 'static',
  '/api/economic/v1/get-crude-inventories': 'daily',
  '/api/economic/v1/get-ecb-fx-rates': 'daily',
  '/api/economic/v1/get-economic-stress': 'daily',
  '/api/economic/v1/get-eu-fsi': 'daily',
  '/api/economic/v1/get-eu-gas-storage': 'daily',
  '/api/economic/v1/get-eu-yield-curve': 'daily',
  '/api/economic/v1/get-nat-gas-storage': 'daily',
  '/api/economic/v1/get-oil-inventories': 'daily',
  '/api/economic/v1/get-oil-stocks-analysis': 'daily',
  '/api/economic/v1/get-economic-calendar': 'medium',
  '/api/economic/v1/list-fuel-prices': 'medium',
  ...
  '/api/consumer-prices/v1/get-consumer-price-basket-series': 'static',
  '/api/consumer-prices/v1/get-consumer-price-freshness': 'static',
  ...
  '/api/imagery/v1/search-imagery': 'slow',
  '/api/infrastructure/v1/get-bootstrap-data': 'slow',
  '/api/infrastructure/v1/get-ip-geo': 'static',
  '/api/infrastructure/v1/reverse-geocode': 'static',
  '/api/webcam/v1/get-webcam-image': 'fast',
  '/api/webcam/v1/list-webcams': 'medium',
  ...
  '/api/supply-chain/v1/list-energy-disruptions': 'slow',
  '/api/supply-chain/v1/list-fuel-shortages': 'slow',
  '/api/supply-chain/v1/get-fuel-shortage-detail': 'slow',
  '/api/supply-chain/v1/list-pipelines': 'daily',
  '/api/supply-chain/v1/get-pipeline-detail': 'daily',
  '/api/supply-chain/v1/list-storage-facilities': 'daily',
  '/api/supply-chain/v1/get-storage-facility-detail': 'daily',
  '/api/supply-chain/v1/get-country-products': 'daily',
