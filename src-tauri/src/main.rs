...
const SUPPORTED_SECRET_KEYS: [&str; 27] = [
    "GROQ_API_KEY",
    "OPENROUTER_API_KEY",
    "TAVILY_API_KEYS",
    "BRAVE_API_KEYS",
...
fn open_settings_window(app: &AppHandle) -> Result<(), String> {
    ...
    let _settings_window = settings_builder
        .build()
...
fn open_live_channels_window(app: &AppHandle, base_url: Option<String>) -> Result<(), String> {
    ...
    #[allow(unused_mut)]
    let mut live_channels_builder = WebviewWindowBuilder::new(app, "live-channels", url)
    ...
    #[cfg(target_os = "macos")]
    {
        live_channels_builder = live_channels_builder.title_bar_style(tauri::TitleBarStyle::Overlay);
    }
    let _live_channels_window = live_channels_builder
    .build()
