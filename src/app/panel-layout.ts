...
export class PanelLayoutManager implements AppModule {
  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://wm.opsio.space')}"
            ...
            <a href="${vHref('tech', 'https://tech.wm.opsio.space')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.wm.opsio.space')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.wm.opsio.space')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.wm.opsio.space')}"
          ...
          <button class="mission-preset-btn" id="missionPresetBtn" title="Choose workspace mission">
            <span class="mission-preset-btn__icon">◎</span>
            MISSION
          </button>
  ...
  private createPanels(): void {
    ...
    if (stockAnalysisPanel && !hasWorldMonitorAccess() && !isProUser()) {
    ...
    if (stockBacktestPanel && !hasWorldMonitorAccess() && !isProUser()) {
    ...
    const _wmKeyPresent = hasWorldMonitorAccess();
