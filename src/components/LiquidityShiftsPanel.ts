...
export class LiquidityShiftsPanel extends Panel {
  ...
  constructor() {
    super({ id: 'liquidity-shifts', title: t('components.liquidityShifts.title'), showCount: false, infoTooltip: t('components.liquidityShifts.infoTooltip') });
  }
    ...
    try {
      ...
      this.setSafeContent(unsafeRawHtml(`
        <div class="liquidity-shifts-panel">
          ...
          ${cotHtml || `<div class="market-symbol">${t('components.liquidityShifts.noCot')}</div>`}
          ...
          ${stockRows || `<div class="market-symbol">${t('components.liquidityShifts.noStocks')}</div>`}
          ${reportDateLine}
        </div>
