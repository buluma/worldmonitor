...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'w_Ma8oQLmSM' },
  ...
  { id: 'ctv-news', name: 'CTV News', hlsUrl: 'https://pe-fa-lp02a.9c9media.com/live/News1Digi/p/hls/00000201/38ef78f479b07aa0/index/0c6a10a2/live/stream/h264/v1/3500000/manifest.m3u8', useFallbackOnly: true, geoAvailability: ['CA'] },
  { id: 'livenow-fox', name: 'LiveNOW from FOX', handle: '@LiveNOWFOX', fallbackVideoId: 'QaftgYkG-ek' },
  { id: 'nasa', name: 'Sen Space Live', handle: '@NASA', fallbackVideoId: 'aB1yRz0HhdY', useFallbackOnly: true },
  ...
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'bjgQzJzCZKs' },
  ...
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'qcTn899skkc' },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'sYZtOFzM78M' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'f0lYfG_vY_U' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'sYZtOFzM78M' },
  ...
  { id: 'rudaw', name: 'Rudaw', hlsUrl: 'https://svs.itworkscdn.net/rudawlive/rudawlive.smil/playlist.m3u8', fallbackVideoId: 'myKybZUK0IA', useFallbackOnly: true },
  ...
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: '4uHZdlX-DT4' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'bjgQzJzCZKs' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'fC_q9TkO1uU' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: 'bNyUyrR0PHo' },
  // Oceania
...
const _REGION_ENTRIES: { key: string; labelKey: string; channelIds: string[] }[] = [
  { key: 'na', labelKey: 'components.liveNews.regionNorthAmerica', channelIds: ['bloomberg', 'cnbc', 'yahoo', 'cnn', 'fox-news', 'newsmax', 'abc-news', 'cbs-news', 'nbc-news', 'cbc-news', 'livenow-fox', 'nasa'] },
...
export class LiveNewsPanel extends Panel {
  ...
  private get embedOrigin(): string {
    ...
    try { return new URL(getRemoteApiBaseUrl()).origin; } catch { return 'https://wm.opsio.space'; }
  }
  ...
  private async renderDesktopEmbedAsync(force = false): Promise<void> {
    ...
    params.set('origin', this.youtubeOrigin || 'https://wm.opsio.space');
