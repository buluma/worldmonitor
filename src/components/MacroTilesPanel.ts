...
export class MacroTilesPanel extends Panel {
  ...
  constructor() {
    super({ id: 'macro-tiles', title: t('components.macroTiles.title'), showCount: false, infoTooltip: t('components.macroTiles.infoTooltip') });
  ...
  private _render(): void {
    ...
    this.setSafeContent(unsafeRawHtml(tabBar + body, 'RPC data escaped at each interpolation point'));
  }
