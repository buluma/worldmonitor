// Ported from koala73/main's src/components/search-scope.ts. Pure, no
// premium/tier logic — trimmed of the 'flight' result type (this fork has
// no flight-callsign search source) but otherwise unchanged.
