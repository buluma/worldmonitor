...
// VITE_VARIANT=tech → tech.wm.opsio.space (tech-focused)
// VITE_VARIANT=full → wm.opsio.space (geopolitical)
// VITE_VARIANT=finance → finance.wm.opsio.space (markets/trading)
