...
// Optimized: Disabled persistCache, increased TTL to 30min
const snapshotBreaker = createCircuitBreaker<GetVesselSnapshotResponse>({ name: 'Maritime Snapshot', cacheTtlMs: 30 * 60 * 1000, persistCache: false });
