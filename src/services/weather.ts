...
// Optimized: Disabled persistCache, increased TTL to 60min
const breaker = createCircuitBreaker<WeatherAlert[]>({ name: 'NWS Weather', cacheTtlMs: 60 * 60 * 1000, persistCache: false });
