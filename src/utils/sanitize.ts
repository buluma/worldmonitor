...
// ---------------------------------------------------------------------------
// SafeHtml — type-tagged HTML strings that have been audited as safe.
// Use escapeHtml() for user content, safeHtml`` for template literals, and
// unsafeRawHtml() with a mandatory audit reason for pre-rendered markup.
// ---------------------------------------------------------------------------
